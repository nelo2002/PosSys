...
if(isset($_POST['check-reset-otp'])){
	...
	$otp .= $otp5;
	$otp .= $otp6;
	$check_code = "SELECT * FROM `admin` WHERE code='$otp'";
	...
	if(mysqli_num_rows($code_res) > 0){
		...
		echo"<script>Swal.fire({
			...
			if (result.isConfirmed) {
			  window.location.assign('New_password.php')
			} 
		  })</script>";
...
?>
		...
		<form action="adminOTPEnter.php" method="post">
                <div id="app">
                    <div class="container height-100 d-flex justify-content-center align-items-center">
                        <div class="position-relative">
                            <div class="card p-2 text-center">
								...
								<div class="mt-3 content d-flex justify-content-center align-items-center"> <span>Didn't get the code ?<a href="resendotpadmin.php?id='send'" class="text-decoration-none ms-3"><b>Resend</b></a></span> </div>
                            </div>
                        </div>
                    </div>
                </div>
